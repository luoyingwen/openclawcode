...
export const zhTW: I18nDictionary = {
  ...
  "opencode.session_status_idle": "閒置",
  ...
  "help.title": "# OpenClawCode 頻道命令",
  "help.opencode": "進入 OpenCode 拦截模式",
  "help.exit": "離開 OpenCode 拦截模式",
  "help.help": "顯示此命令列表",
  "help.status": "顯示 OpenCode 健康狀態和插件狀態",
  "help.projects": "列出 OpenCode 項目",
  "help.project": "通過編號或路徑選擇項目",
  "help.sessions": "列出當前項目的會話",
  "help.session": "通過編號選擇會話",
  "help.agents": "列出可用代理",
  "help.agent": "選擇指定編號的代理",
  "help.models": "列出可用模型",
  "help.model": "選擇指定編號的模型",
  "help.new": "創建並選擇新的 OpenCode 會話",
  "help.rename": "重命名當前會話（交互式）",
  "help.stop": "中止當前 OpenCode 會話或取消活動流程",
  "help.task": "啟動計劃任務創建流程",
  "help.tasklist": "查看和管理計劃任務",
  "help.permission": "顯示待處理的權限請求或風險狀態",
  "help.commands": "列出 OpenCode 暴露的項目命令",
  "help.permission_replies": "**權限回覆：**",
  "help.permission_1": "允許一次",
  "help.permission_2": "始終允許",
  "help.permission_3": "拒絕",
  "help.intercept_hint": "除 /opencode 和 /exit 外，所有命令僅在拦截模式啟用後有效。",

  "agent.list_title": "# 可用代理",
  "agent.current": "當前：{current}",
  "agent.select_hint": "使用 `/agent <編號>` 選擇代理。",
  "agent.invalid_index": "無效的代理索引。使用 /agents 查看當前列表。",
  "agent.usage": "用法：/agent <編號>。使用 /agents 列出可用代理。",
  "agent.no_session": "未選擇會話。先使用 `/sessions` 選擇會話。",
  "agent.rename_prompt": '請輸入會話 "{title}" 的新標題。\n\n💡 使用 /stop 取消。',
  "agent.no_project": "未選擇項目。先使用 `/projects`。",
  ...
  "project.list_title": "# 項目（{count}/{total}）",
  "project.select_hint": "使用 `/project <編號>` 選擇項目，或 `/project <路徑>` 通過路徑選擇。",
  "session.list_title": "# 會話（{count}/{total}）",
  "session.select_hint": "使用 `/session <編號>` 選擇會話。",
};
