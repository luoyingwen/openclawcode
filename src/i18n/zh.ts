...
export const zh: I18nDictionary = {
  ...
  "models.favorites": "**收藏：**",
  "models.recent": "**最近使用：**",
  "models.current": "**当前：** {model}",
  "models.current_none": "**当前：** 无",
  "models.fetch_error": "获取模型失败：{error}",
  "model.select_error": "选择模型失败：{error}",
  ...
  "help.title": "# OpenClawCode 频道命令",
  "help.opencode": "进入 OpenCode 拦截模式",
  "help.exit": "离开 OpenCode 拦截模式",
  "help.help": "显示此命令列表",
  "help.status": "显示 OpenCode 健康状态和插件状态",
  "help.projects": "列出 OpenCode 项目",
  "help.project": "通过编号或路径选择项目",
  "help.sessions": "列出当前项目的会话",
  "help.session": "通过编号选择会话",
  "help.agents": "列出可用代理",
  "help.agent": "选择指定编号的代理",
  "help.models": "列出可用模型",
  "help.model": "选择指定编号的模型",
  "help.new": "创建并选择新的 OpenCode 会话",
  "help.rename": "重命名当前会话（交互式）",
  "help.stop": "中止当前 OpenCode 会话或取消活动流程",
  "help.task": "启动计划任务创建流程",
  "help.tasklist": "查看和管理计划任务",
  "help.permission": "显示待处理的权限请求或风险状态",
  "help.commands": "列出 OpenCode 暴露的项目命令",
  "help.permission_replies": "**权限回复：**",
  "help.permission_1": "允许一次",
  "help.permission_2": "始终允许",
  "help.permission_3": "拒绝",
  "help.intercept_hint": "除 /opencode 和 /exit 外，所有命令仅在拦截模式启用后有效。",

  "agent.list_title": "# 可用代理",
  "agent.current": "当前：{current}",
  "agent.select_hint": "使用 `/agent <编号>` 选择代理。",
  "agent.invalid_index": "无效的代理索引。使用 /agents 查看当前列表。",
  "agent.usage": "用法：/agent <编号>。使用 /agents 列出可用代理。",
  "agent.no_session": "未选择会话。先使用 `/sessions` 选择会话。",
  "agent.rename_prompt": '请输入会话 "{title}" 的新标题。\n\n💡 使用 /stop 取消。',
  "agent.no_project": "未选择项目。先使用 `/projects`。",
  ...
  "project.list_title": "# 项目（{count}/{total}）",
  "project.select_hint": "使用 `/project <编号>` 选择项目，或 `/project <路径>` 通过路径选择。",
  "session.list_title": "# 会话（{count}/{total}）",
  "session.select_hint": "使用 `/session <编号>` 选择会话。",
};
